...
\end{lm}
\marginpar{A priori così non basta, se il gruppo non è abeliano. Le frecce tra parentesi vanno bene?}
\begin{proof}
  ...
  %Partendo da $g^{-1}$ avremmo ottenuto $g^{-1}=g_x^{-1}h$, perciò $g=h^{-1}g_x$ con $h^{-1} \in G_{x_0}$.
\end{proof}
...
\begin{proof}
  ...
  \end{equation}
  \marginpar{osservazione maiuscolo o minuscolo?}
