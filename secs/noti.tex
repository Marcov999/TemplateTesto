...
\begin{proof}
  ...
  Partendo da $g^{-1}$ avremmo ottenuto $g^{-1}=g_x^{-1}h$ $\implies$ $g=h^{-1}g_x$ con $h^{-1} \in G_{x_0}$.
\end{proof}
...
\begin{proof}
  ...
  \begin{gather*}
    ...
    |f(z)|<1
  \end{gather*}
  e quindi $f(z) \in \mathbb{D}$. L'inversa è $f^{-1}(z)=e^{-i\theta}\dfrac{z+ae^{i\theta}}{z+\bar{a}e^{-i\theta}z}$, della stessa forma. Si noti che $f(a)=0$.
