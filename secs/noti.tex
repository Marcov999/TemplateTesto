...
Com'è noto, la condizione di olomorfia per funzioni a valori complessi è molto più forte della derivabilità in senso reale (in particolare, è equivalente all'analiticità), il che rende le funzioni olomorfe degli oggetti piuttosto rigidi. Fra i vari risultati noti per tali funzioni, ci interessa il lemma di Schwarz-Pick: vogliamo vederlo appunto come risultato di rigidità, per poi dimostrarne versione al bordo.
