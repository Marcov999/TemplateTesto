...
Per le funzioni in $\mathcal{S}$ è stato congetturato da Bieberbach \cite{B} e poi dimostrato da de Branges \cite{dB} che vale $|a_n| \le n$. Vediamo come questo ci dà immediatamente la maggiorazione:
\begin{align*}
