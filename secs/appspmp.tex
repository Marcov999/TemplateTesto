...
Del prossimo enunciato dimostreremo solo un paio di casi particolari.

\begin{thm}
  (Pick-Nevanlinna) Siano dati $n$ punti distinti $z_1, \dots, z_n \in \mathbb{D}$ e altri $n$ punti distinti (non necessariamente diversi dai primi) $w_1, \dots, z_n \in \mathbb{D}$. Per $k=1, \dots, n$, sia $A_k$ la matrice $k \times k$ data da $A_k(i,j)=\dfrac{1-w_i\bar{w}_j}{1-z_i\bar{z}_j}$.
...
Concludiamo la sezione con il risultato che, come già anticipato, ci permetterà di dimostrare i teoremi successivi.
