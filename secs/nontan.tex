\begin{defn} \marginpar{si usa "modulo minore di" con gli angoli? Non sapevo}
...
\begin{proof}
  ...
  \marginpar{Ho provato con due righe, ma viene tutto accrocchiato e non mi sembra comprensibilissimo. Posso provare a riformulare questi ultimi passaggi}
  \begin{align*}
...
\begin{proof}
  ...
  \begin{align*}
    ...
    & =|f'(\sigma z)|\frac{1-|\sigma z|^2}{1-|f(\sigma z)|^2}=|f^h(\sigma z)|
  \end{align*}
  ...
  \begin{align*}
    ...
    & =\epsilon r(z)^2(1+\csc\gamma)^3 \le \epsilon r(z)^2\bigl(1+\csc(\beta-\alpha)\bigr)^3 \\
