...
\begin{proof}
  ...
  \begin{align*}
    |I(z)| & =\left|\frac{1}{2\pi i} \int_{C(z)} \frac{f(w)-w}{(w-z)^2}\diff w\right| \le \frac{1}{2\pi} \int_0^{2\pi} \frac{\epsilon|1-\bigl(z+r(z)e^{i\theta}\bigr)|^3}{|\bigl(z+r(z)e^{i\theta}\bigr)-z|^2}r(z)\diff\theta \\
    & \le \frac{\epsilon}{r(z)}\max_{\theta \in [0,2\pi]} |1-\bigl(z+r(z)e^{i\theta}\bigr)|^3=\frac{\epsilon}{r(z)}\max_{w \in C(z)}|1-w|^3.
  \end{align*}
