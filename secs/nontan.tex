...
\begin{proof}
  ...
  \marginpar{forse nella seconda riga si può mettere direttamente l'ultima formula}
  \begin{align*}
...
\begin{proof}
  ...
  \marginpar{forse può essere scritto in modo da rendere più chiaro cosa stai facendo}
  ...
  \marginpar{forse si può rendere più comprensibile, a costo di allungare un po' la dimsotrazione e riarrangiare le ipotesi viste nel paragrafo che precede queste formule}
  \begin{align*}
